...
public interface AlienRepo_DAO extends JpaRepository<Alien, Integer> // Since we are using Spring JPA, it gives us the awsome features //<> work with type Alien and the primary key of type Integer
